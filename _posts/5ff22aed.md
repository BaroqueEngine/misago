...
昇順でソート済みの配列に対して二分探索を行い、検索する値が存在するかを確かめます。
...
昇順でソート済みの配列に対して二分探索を行い、検索する値未満の数が左側に、以上の数が右側にくる位置をイテレータとして返します。
...
昇順でソート済みの配列に対して二分探索を行い、検索する値以下の数が左側に、より大きい数が右側にくる位置をイテレータとして返します。
